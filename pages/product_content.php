...
<div class="content">
    <div class="products-agileinfo">
        <h2 class="tittle">Product details</h2>
        <div class="container">
            <div class="product-agileinfo-grids w3l">
                <div class="col-md-3 product-agileinfo-grid">
                    ...
                    <div class="cat-img">
                        <img class="img-responsive " src="assets/front_end/images/45.jpg" alt="">
                    </div>
                </div>
                <div class="col-md-9 product-agileinfon-grid1 w3l">
                    <div class="product-agileinfon-top">
                        <div class="col-md-6 product-agileinfon-top-left">
                            <img class="img-responsive " src="assets/front_end/images/img1.jpg" alt="">
                        </div>
                        <div class="col-md-6 product-agileinfon-top-left">
                            <img class="img-responsive " src="assets/front_end/images/img2.jpg" alt="">
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    ...
                    <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav1 nav1-tabs left-tab" role="tablist">
                            <ul id="myTab" class="nav nav-tabs left-tab" role="tablist">
                                <li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true"><img src="assets/front_end/images/menu1.png"></a></li>
                                <li role="presentation"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile"><img src="assets/front_end/images/menu.png"></a></li>
                            </ul>
                                        ...
                                        <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                            <div class="grid-arr">
                                                <div  class="grid-arrival">
                                                    <figure>		
                                                        <a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
                                                            <div class="grid-img">
                                                                <a href="product_details.php?id=<?php echo $category_product['product_id']; ?>"><img  src="assets/<?php echo $category_product['product_image']; ?>" class="img-responsive" alt=""height="300" width="200"></a>
                                                            </div>
                                                ...
                                                <div class="women">
                                                    ...
                                                    <p ><em class="item_price"> BDT <?php echo $category_product['product_price']; ?></em></p>
                                                    <a href="product_details.php" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
                                                </div>
                                            </div>
                                        </div>
                                        <?php } ?>

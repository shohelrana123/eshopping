...
<!-- cart -->
<script defer src="assets/front_end/js/jquery.flexslider.js"></script>
...
<!--//End-rate-->
<link href="assets/front_end/css/owl.carousel.css" rel="stylesheet">
...
<div class="content">
    <!--single-->
    <br>
    <h2 class="text text-center text-danger">Product Details</h2>
                ...
                <div class="col-md-9 single-grid">
                    <div clas="single-top">
                        ...
                        <div class="single-right simpleCart_shelfItem">
                            ...
                            <p class="price item_price">BDT <?php echo $product_info['product_price']; ?></p>
                            ...
                            <div class="social-icon">
                                ...
                                <a href="https://twitter.com/"><i class="icon1"></i></a>
                                <a href="https://plus.google.com/"><i class="icon2"></i></a>
                                <a href="https://www.linkedin.com/"><i class="icon3"></i></a>
                            </div>
                        </div>
                ...
                <div class="col-md-3 single-grid1">
                    ...
                    <div class="recent-grids">
                        <div class="recent-left">
                            <a href="single.html"><img class="img-responsive " src="assets/front_end/images/r.jpg" alt=""></a>	
                        </div>
                    ...
                    <div class="recent-grids">
                        <div class="recent-left">
                            <a href="single.html"><img class="img-responsive " src="assets/front_end/images/r1.jpg" alt=""></a>	
                        </div>
                        <div class="recent-right">
                    ...
                    <div class="recent-grids">
                        <div class="recent-left">
                            <a href="single.html"><img class="img-responsive " src="assets/front_end/images/r2.jpg" alt=""></a>	
                        </div>
                        <div class="recent-right">
                            <h6 class="best2"><a href="single.html">Lorem ipsum dolor </a></h6>
                            <div class="block">
                    ...
                    <div class="recent-grids">
                        <div class="recent-left">
                            <a href="single.html"><img class="img-responsive " src="assets/front_end/images/r3.jpg" alt=""></a>	
                        </div>
                        <div class="recent-right">
                    ...
                    <div class="col-md-4 product-grid">
                        <div id="owl-demo" class="owl-carousel">
                            ...
                            <div class="item">
                                <div class="recent-grids">
                                    <div class="recent-left">
                                        <a href="single.html"><img class="img-responsive " src="assets/front_end/images/r4.jpg" alt=""></a>	
                                    </div>
                                    <div class="recent-right">
                                        <h6 class="best2"><a href="single.html">Lorem ipsum dolor </a></h6>
                                        <div class="block">
                                ...
                                <div class="recent-grids">
                                    <div class="recent-left">
                                        <a href="single.html"><img class="img-responsive " src="assets/front_end/images/r5.jpg" alt=""></a>	
                                    </div>
                                    <div class="recent-right">
                                        <h6 class="best2"><a href="single.html">Duis aute irure </a></h6>
                                        <div class="block">
                        ...
                        <img class="img-responsive " src="assets/front_end/images/woo2.jpg" alt="">
                    </div>
